...
{
	public sealed class ForeignKeyObjectsUtil
	{
		private ForeignKeyObjectsUtil() { }

		public static ForeignKeyObjectsUtil _foreignKeyObjectsUtilInstance;

		public static ForeignKeyObjectsUtil getInstance()
        {
			if(_foreignKeyObjectsUtilInstance == null)
            {
				_foreignKeyObjectsUtilInstance = new ForeignKeyObjectsUtil();
            }
			return _foreignKeyObjectsUtilInstance;
        }
