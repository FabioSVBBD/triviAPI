...
public class FilterQuery
{
    ...
    public FilterQuery(QueryValidator validData, HttpRequest request)
    {
    ...
    private void byCategory()
    {
        ...
        {
            bool countedCategories = queryValidator.categories.Count > 0;

            foundData = !countedCategories ? foundData : foundData.Where(x =>
        ...
        else
        {
            ...
            categoryQuestions.ForEach(x => addToFoundData(x));
        }
    }
    ...
    private void byDifficulty()
    {
        ...
        else
        {
            ...
            difficultyQuestions.ForEach(x => addToFoundData(x));
        }
    }
